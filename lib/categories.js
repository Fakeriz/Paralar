...
export const CARD_THEMES = [
  ...
  },
  {
    ...
    className: 'bg-gradient-to-br from-[#0c1322] via-[#09101d] to-[#040810] text-white border border-[#6A92FC]/35 shadow-lg shadow-[#6A92FC]/10',
    swatchClass: 'bg-gradient-to-br from-[#1b2b52] via-[#101b33] to-[#040810] border border-[#6A92FC]/60',
    isLight: false,
    network: 'visa',
  },
]
